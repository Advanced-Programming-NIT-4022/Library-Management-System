...
public class CLI {
    ...
    public static void changeHours(Library l) {
...
//حالا میاد یوزر رو تو ارری لیست هامون ادد میکنه
    ...
    public static void rentBook(Library l, String name) {
                    ...
                    for (NormalUser NormUser : l.userArray) {
                        if (NormUser.getUnique_ID() == userId) {
                            ...
                            if (nameMember.equals(NormUser.getName())) {
                                ...
                                System.out.println(PURPLE+"You have rented the book named " + name + " successfully.");
    ...
    public static void rentBookie(Library l,String name ,String memberName ,String memberId){
        boolean bookFound = false;
        for (Book book_repo : l.book_repository) {
            if (book_repo.getTitle().equals(name)) {
                bookFound = true;
    ...
    public static boolean regex(String s, Library lib, boolean b) {
        ...
        if (match5.find()) {
            rentBookie(lib,match5.group(1),match5.group(2),match5.group(3));
            return true;
        }
