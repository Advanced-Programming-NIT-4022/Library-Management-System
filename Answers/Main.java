...
public class Main {
    ...
    private static void processCommand(Library library, Scanner scanner, String command) {
        String[] parts = command.split(" ");  // Split command by spaces
                ...
                switch (parts[1]) {
                    case "add":
                        if (parts.length < 4) {
                            ...
                            String subtitle = parts.length > 4 ? parts[4] : ""; // Optional subtitle
                    ...
                    case "get":
                        if (parts.length < 2) {
                            ...
                            switch (parts[2]) {
                                case "hrs":
                                    System.out.println("Library operating hours: [Enter library hours here]"); // Replace with actual hours
                                    break;
                                case "available":
